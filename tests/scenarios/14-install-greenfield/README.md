...
Tests the `/ark` skill **orchestration itself**, not just the scaffolded result.
...
- Placeholder population — interview answers land in the documented files
  (per [`prompts/interview.md § What the answers feed`](../../../.claude/skills/ark/prompts/interview.md))
...
and skip the `/ark` orchestration — appropriate for testing PM lifecycle moves on a
